    ...
    return (
        <div>
            <footer className="border-t-2 border-border">
                <div className="max-w-screen-xl mx-auto px-4 py-4 md:px-0 md:py-4 flex justify-between items-center">
                    <div className="text-sm md:text-normal">© Copyright 2023</div>
